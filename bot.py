...
class MusicCog(commands.Cog):
    ...
    @app_commands.command(name="toxic", description="Chửi đụ đĩ mẹ mày (chỉ 1 câu)")
    @app_commands.describe(user="Người bạn muốn chửi")
    async def toxic(self, interaction: discord.Interaction, user: discord.Member):
        await interaction.response.send_message(f"Đụ đĩ mẹ mày {user.mention}")
